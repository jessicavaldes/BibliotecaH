...
<%@page import="Clases.UsuarioB"%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@page import="Clases.Usuario"%>
<%
    String acc = request.getParameter("acc");
    Usuario h = new Usuario();
    UsuarioB b = new UsuarioB();
    ArrayList<Usuario> k = new ArrayList();
    k = (ArrayList) b.BuscarTodos();
    boolean off = true;
    boolean tipo = false;
    try {
        ...
        <div class="fondoP">
            <div class="FullScreen">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="navbar-header">
                            <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
                                <span class="sr-only">Biblioteca Xanat</span>
                                <span class="icon-bar"></span>
                                <span class="icon-bar"></span>
                                <span class="icon-bar"></span>
                            </button>
                            <a class="navbar-brand page-scroll" href="index.jsp#HOME">Biblioteca Xanat</a>
                        </div>
                ...
                <div id="contenido">
                    <div id="info-menu">
                        <ul>
                            <li><a href="?acc=1" >Modificar mi información</a></li>
                            <li><a href="?acc=2" >Agregar Bibliotecario(a)</a></li>
                        ...
                        <div id="formulario">
                            <div id="campos">
                                <%if (acc != null && (acc.equals("1") || acc.equals("2") || acc.equals("3") || acc.equals("4"))) {
                                        String[] titulo = {"Modificar mi información","Agregar Bibliotecario(a)", "Eliminar Bibliotecario(a)", "Lista de Usuarios"};
